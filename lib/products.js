export const products = [
  ...
  {
    id: 'paleta-pack-1',
    name: 'Paleta Ibérica de Cebo - Pack 1',
    title: 'PACK 1',
    subtitle: 'Paleta Ibérica',
    description: 'Espectacular Paleta Ibérica de Cebo. Calidad premium garantizada, ideal para los que prefieren el sabor intenso de la paleta. Envío incluido.',
    price: 51.95,
    quantity: 1,
    image: '/paleta.png',
    popular: false,
  ...
  {
    id: 'paleta-pack-2',
    name: 'Paleta Ibérica de Cebo - Pack 2',
    title: 'PACK 2',
    subtitle: 'Paleta Ibérica',
    description: 'Doble disfrute con nuestro Pack 2 de Paleta Ibérica de Cebo. La mejor elección para tener siempre a mano el mejor sabor ibérico. Envío incluido.',
    price: 87.95,
    quantity: 2,
    image: '/paleta.png',
    popular: true,
